...
- Shared common production owns the deterministic parser/model/codec/policy families previously documented for the KMP closeout, while BLE/session/GATT host behavior, generated public protobuf reconstruction, public facade error translation, filesystem capability gates, transport execution, timeout scheduling, cancellation mechanics, progress emission, and side-effectful firmware/backup execution remain platform-owned.
