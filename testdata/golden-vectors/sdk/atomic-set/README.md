...
These vectors characterize Android `AtomicSet` behavior and the shared KMP `PolarAtomicSet` compatibility fixture used by the Android wrapper. The broader atomic and stream-continuation helpers remain platform/runtime primitives; only this collection-like contract is common-owned.
