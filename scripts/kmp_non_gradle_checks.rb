...
PLATFORM_OWNED_COVERAGE_ROWS = {
  ...
  "GATT clients" => ["Partial", "platform-owned", "Keep transport clients platform-specific", "HTS temperature measurement byte codec, BAS battery status bitfield codec, HR measurement byte codec, and RSC measurement byte codec are shared common-owned while notification lifecycle stays platform-owned"],
