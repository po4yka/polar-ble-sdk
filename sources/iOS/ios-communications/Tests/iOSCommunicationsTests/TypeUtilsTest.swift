...
final class TypeUtilsTest: XCTestCase {
    ...
    func testTypeUtilsDelegatesCompatibleConversionsToSharedKmpWhenLinked() throws {
        ...
        XCTAssertEqual(Int32(-32768), TypeRuntimePlanner.signedInt(data: Data([0x00, 0x80])))
        XCTAssertEqual(Int32(-32768), TypeRuntimePlanner.signedInt(data: Data([0x7f, 0x00, 0x80, 0x01]), offset: 1, size: 2))
        XCTAssertEqual(UInt64.max, TypeRuntimePlanner.unsignedLong(data: Data([0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff])))
        XCTAssertEqual(UInt64.max, TypeRuntimePlanner.unsignedLong(data: Data([0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]), offset: 1, size: 8))
