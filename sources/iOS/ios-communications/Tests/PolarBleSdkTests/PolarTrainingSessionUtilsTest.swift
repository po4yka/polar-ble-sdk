...
final class PolarTrainingSessionUtilsTests: XCTestCase {
    ...
    func testPayloadParserPolicyVectorPinsByteLevelParserOwnership() throws {
    ...
    func testTrainingSessionReadinessManifestPinsSharedOwnership() throws {
