...
public nonisolated struct Data_PbExerciseRouteSamples: Sendable {
  ...
  /// gps altitude
  public var gpsAltitude: [Int32] = []

  /// number of satellites
  public var satelliteAmount: [UInt32] = []

  /// fix status
  public var obsoleteFix: [Bool] = []

  /// indicate start and stop indexes when there has not been connection to gps sensor
  public var obsoleteGpsOffline: [PbSensorOffline] = []

  /// GPS date and time in UTC
  public var obsoleteGpsDateTime: [PbSystemDateTime] = []

  /// GPS date and time of first location point
  public var firstLocationTime: PbSystemDateTime {
    get {_firstLocationTime ?? PbSystemDateTime()}
    set {_firstLocationTime = newValue}
  }
  /// Returns true if `firstLocationTime` has been explicitly set.
  public var hasFirstLocationTime: Bool {self._firstLocationTime != nil}
  /// Clears the value of `firstLocationTime`. Subsequent reads from it will return its default value.
  public mutating func clearFirstLocationTime() {self._firstLocationTime = nil}
...
nonisolated extension Data_PbExerciseRouteSamples: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbExerciseRouteSamples"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}duration\0\u{1}latitude\0\u{1}longitude\0\u{3}gps_altitude\0\u{3}satellite_amount\0\u{3}OBSOLETE_fix\0\u{3}OBSOLETE_gps_offline\0\u{3}OBSOLETE_gps_date_time\0\u{3}first_location_time\0")
