...
nonisolated extension Data_PbPpIntervalSamples: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbPpIntervalSamples"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ppi_delta\0\u{3}ppi_error_estimate_delta\0\u{1}status\0")
  ...
  public static func ==(lhs: Data_PbPpIntervalSamples, rhs: Data_PbPpIntervalSamples) -> Bool {
