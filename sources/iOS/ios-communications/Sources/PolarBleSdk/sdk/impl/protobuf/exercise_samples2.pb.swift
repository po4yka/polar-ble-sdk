...
public nonisolated struct Data_PbExerciseSamplesSyncPoint: Sendable {
  ...
  public var forwardAccelerationSampleGranularity: UInt32 {
    get {_forwardAccelerationSampleGranularity ?? 100}
  ...
  public var hasForwardAccelerationSampleGranularity: Bool {self._forwardAccelerationSampleGranularity != nil}
  /// Clears the value of `forwardAccelerationSampleGranularity`. Subsequent reads from it will return its default value.
  public mutating func clearForwardAccelerationSampleGranularity() {self._forwardAccelerationSampleGranularity = nil}
  ...
  public var accelerationMadSampleGranularity: UInt32 {
    get {_accelerationMadSampleGranularity ?? 100}
    set {_accelerationMadSampleGranularity = newValue}
  }
  /// Returns true if `accelerationMadSampleGranularity` has been explicitly set.
  public var hasAccelerationMadSampleGranularity: Bool {self._accelerationMadSampleGranularity != nil}
  /// Clears the value of `accelerationMadSampleGranularity`. Subsequent reads from it will return its default value.
  public mutating func clearAccelerationMadSampleGranularity() {self._accelerationMadSampleGranularity = nil}
...
public nonisolated struct Data_PbExerciseIntervalledSample2List: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Data_PbExerciseSamples2: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Data_PbExerciseSamplesSyncPoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbExerciseSamplesSyncPoint"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}index\0\u{3}heart_rate_sample\0\u{3}cadence_sample\0\u{3}speed_sample\0\u{3}distance_sample\0\u{3}forward_acceleration_sample\0\u{3}speed_sample_granularity\0\u{3}distance_sample_granularity\0\u{3}forward_acceleration_sample_granularity\0\u{3}acceleration_mad_sample\0\u{3}acceleration_mad_sample_granularity\0")
...
nonisolated extension Data_PbExerciseIntervalledSample2List: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbExerciseIntervalledSample2List"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}sample_type\0\u{3}recording_interval_ms\0\u{3}sync_point\0\u{3}sample_source\0\u{3}heart_rate_samples\0\u{3}cadence_samples\0\u{3}speed_samples\0\u{3}distance_samples\0\u{3}forward_acceleration_samples\0\u{3}moving_type_samples\0\u{3}acceleration_mad_samples\0")
...
nonisolated extension Data_PbExerciseSamples2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbExerciseSamples2"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}exercise_intervalled_sample2_list\0")
