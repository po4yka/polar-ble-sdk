...
public nonisolated struct Data_PbPowerMeasurements: Sendable {
  ...
  public var hasCurrentPower: Bool {self._currentPower != nil}
  ...
  public var cumulativeCrankRevolutions: UInt32 {
    get {_cumulativeCrankRevolutions ?? 0}
    set {_cumulativeCrankRevolutions = newValue}
  }
  /// Returns true if `cumulativeCrankRevolutions` has been explicitly set.
  public var hasCumulativeCrankRevolutions: Bool {self._cumulativeCrankRevolutions != nil}
  ...
  public var cumulativeTimestamp: UInt32 {
    get {_cumulativeTimestamp ?? 0}
    set {_cumulativeTimestamp = newValue}
  }
  /// Returns true if `cumulativeTimestamp` has been explicitly set.
  public var hasCumulativeTimestamp: Bool {self._cumulativeTimestamp != nil}
  ...
  public var forceMagnitudeMin: Int32 {
    get {_forceMagnitudeMin ?? 0}
    set {_forceMagnitudeMin = newValue}
  }
  /// Returns true if `forceMagnitudeMin` has been explicitly set.
  public var hasForceMagnitudeMin: Bool {self._forceMagnitudeMin != nil}
  ...
  public var forceMagnitudeMax: Int32 {
    get {_forceMagnitudeMax ?? 0}
    set {_forceMagnitudeMax = newValue}
  }
  /// Returns true if `forceMagnitudeMax` has been explicitly set.
  public var hasForceMagnitudeMax: Bool {self._forceMagnitudeMax != nil}
  ...
  public var forceMagnitudeMinAngle: UInt32 {
    get {_forceMagnitudeMinAngle ?? 0}
    set {_forceMagnitudeMinAngle = newValue}
  }
  /// Returns true if `forceMagnitudeMinAngle` has been explicitly set.
  public var hasForceMagnitudeMinAngle: Bool {self._forceMagnitudeMinAngle != nil}
  ...
  public var forceMagnitudeMaxAngle: UInt32 {
    get {_forceMagnitudeMaxAngle ?? 0}
    set {_forceMagnitudeMaxAngle = newValue}
  }
  /// Returns true if `forceMagnitudeMaxAngle` has been explicitly set.
  public var hasForceMagnitudeMaxAngle: Bool {self._forceMagnitudeMaxAngle != nil}
  ...
  public var bottomDeadSpotAngle: UInt32 {
    get {_bottomDeadSpotAngle ?? 0}
    set {_bottomDeadSpotAngle = newValue}
  }
  /// Returns true if `bottomDeadSpotAngle` has been explicitly set.
  public var hasBottomDeadSpotAngle: Bool {self._bottomDeadSpotAngle != nil}
  ...
  public var pedalPowerBalance: UInt32 {
    get {_pedalPowerBalance ?? 0}
    set {_pedalPowerBalance = newValue}
  }
  /// Returns true if `pedalPowerBalance` has been explicitly set.
  public var hasPedalPowerBalance: Bool {self._pedalPowerBalance != nil}
  ...
  public var torqueMagnitudeMin: Int32 {
    get {_torqueMagnitudeMin ?? 0}
    set {_torqueMagnitudeMin = newValue}
  }
  /// Returns true if `torqueMagnitudeMin` has been explicitly set.
  public var hasTorqueMagnitudeMin: Bool {self._torqueMagnitudeMin != nil}
  ...
  public var torqueMagnitudeMax: Int32 {
    get {_torqueMagnitudeMax ?? 0}
    set {_torqueMagnitudeMax = newValue}
  }
  /// Returns true if `torqueMagnitudeMax` has been explicitly set.
  public var hasTorqueMagnitudeMax: Bool {self._torqueMagnitudeMax != nil}
...
public nonisolated struct Data_PbCalibrationValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Data_PbExerciseIntervalledSampleList: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var sampleType: PbSampleType {
    get {_storage._sampleType ?? .sampleTypeUndefined}
    set {_uniqueStorage()._sampleType = newValue}
  }
  /// Returns true if `sampleType` has been explicitly set.
  public var hasSampleType: Bool {_storage._sampleType != nil}
  ...
  public var recordingIntervalMs: UInt32 {
    get {_storage._recordingIntervalMs ?? 0}
    set {_uniqueStorage()._recordingIntervalMs = newValue}
  }
  /// Returns true if `recordingIntervalMs` has been explicitly set.
  public var hasRecordingIntervalMs: Bool {_storage._recordingIntervalMs != nil}
  ...
  public var movingTypeSamples: [PbMovingType] {
    get {_storage._movingTypeSamples}
  ...
  public var strideLengthSamples: [UInt32] {
    get {_storage._strideLengthSamples}
  ...
  public var strideCalibration: [Data_PbCalibrationValue] {
    get {_storage._strideCalibration}
  ...
  public var leftPedalPowerSamples: [Data_PbPowerMeasurements] {
    get {_storage._leftPedalPowerSamples}
  ...
  public var rightPedalPowerSamples: [Data_PbPowerMeasurements] {
    get {_storage._rightPedalPowerSamples}
  ...
  public var leftPowerCalibration: [Data_PbCalibrationValue] {
    get {_storage._leftPowerCalibration}
  ...
  public var rightPowerCalibration: [Data_PbCalibrationValue] {
    get {_storage._rightPowerCalibration}
  ...
  public var rrSamples: Data_PbExerciseRRIntervals {
    get {_storage._rrSamples ?? Data_PbExerciseRRIntervals()}
    set {_uniqueStorage()._rrSamples = newValue}
  }
  /// Returns true if `rrSamples` has been explicitly set.
  public var hasRrSamples: Bool {_storage._rrSamples != nil}
  ...
  public var accelerationMadSamples: [Float] {
    get {_storage._accelerationMadSamples}
...
public nonisolated struct Data_PbExerciseSamples: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var recordingInterval: PbDuration {
    get {_storage._recordingInterval ?? PbDuration()}
    set {_uniqueStorage()._recordingInterval = newValue}
  }
  /// Returns true if `recordingInterval` has been explicitly set.
  public var hasRecordingInterval: Bool {_storage._recordingInterval != nil}
  ...
  public var heartRateOffline: [PbSensorOffline] {
    get {_storage._heartRateOffline}
  ...
  public var temperatureOffline: [PbSensorOffline] {
    get {_storage._temperatureOffline}
  ...
  public var strideLengthOffline: [PbSensorOffline] {
    get {_storage._strideLengthOffline}
  ...
  public var forwardAccelerationOffline: [PbSensorOffline] {
    get {_storage._forwardAccelerationOffline}
  ...
  public var movingTypeOffline: [PbSensorOffline] {
    get {_storage._movingTypeOffline}
  ...
  public var leftPedalPowerOffline: [PbSensorOffline] {
    get {_storage._leftPedalPowerOffline}
  ...
  public var rightPedalPowerOffline: [PbSensorOffline] {
    get {_storage._rightPedalPowerOffline}
  ...
  public var bodyTemperatureOffline: [PbSensorOffline] {
    get {_storage._bodyTemperatureOffline}
...
nonisolated extension Data_PbPowerMeasurements: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbPowerMeasurements"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}current_power\0\u{3}cumulative_crank_revolutions\0\u{3}cumulative_timestamp\0\u{3}force_magnitude_min\0\u{3}force_magnitude_max\0\u{3}force_magnitude_min_angle\0\u{3}force_magnitude_max_angle\0\u{3}bottom_dead_spot_angle\0\u{3}top_dead_spot_angle\0\u{3}pedal_power_balance\0\u{3}torque_magnitude_min\0\u{3}torque_magnitude_max\0")
...
nonisolated extension Data_PbCalibrationValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbCalibrationValue"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_index\0\u{1}value\0\u{1}operation\0\u{1}cause\0")
...
nonisolated extension Data_PbExerciseIntervalledSampleList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbExerciseIntervalledSampleList"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}sample_type\0\u{3}recording_interval_ms\0\u{3}sample_source\0\u{3}heart_rate_samples\0\u{3}cadence_samples\0\u{3}speed_samples\0\u{3}distance_samples\0\u{3}forward_acceleration\0\u{3}moving_type_samples\0\u{3}altitude_samples\0\u{3}altitude_calibration\0\u{3}temperature_samples\0\u{3}stride_length_samples\0\u{3}stride_calibration\0\u{3}left_pedal_power_samples\0\u{3}right_pedal_power_samples\0\u{3}left_power_calibration\0\u{3}right_power_calibration\0\u{3}rr_samples\0\u{3}acceleration_mad_samples\0")
...
nonisolated extension Data_PbExerciseSamples: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbExerciseSamples"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}recording_interval\0\u{3}heart_rate_samples\0\u{3}heart_rate_offline\0\u{3}cadence_samples\0\u{3}cadence_offline\0\u{3}altitude_samples\0\u{3}altitude_calibration\0\u{3}temperature_samples\0\u{3}speed_samples\0\u{3}speed_offline\0\u{3}distance_samples\0\u{3}distance_offline\0\u{3}stride_length_samples\0\u{3}stride_length_offline\0\u{3}stride_calibration\0\u{3}forward_acceleration\0\u{3}moving_type_samples\0\u{3}altitude_offline\0\u{3}temperature_offline\0\u{3}forward_acceleration_offline\0\u{3}moving_type_offline\0\u{3}left_pedal_power_samples\0\u{3}left_pedal_power_offline\0\u{3}right_pedal_power_samples\0\u{3}right_pedal_power_offline\0\u{3}left_power_calibration\0\u{3}right_power_calibration\0\u{3}rr_samples\0\u{3}exercise_intervalled_sample_list\0\u{3}pause_times\0\u{3}body_temperature\0\u{3}body_temperature_offline\0")
