...
public nonisolated struct Data_PbExerciseRRIntervals: Sendable {
...
nonisolated extension Data_PbExerciseRRIntervals: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbExerciseRRIntervals"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}rr_intervals\0")
