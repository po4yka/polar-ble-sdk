...
public nonisolated struct Data_PbNightlyRecoveryStatus: @unchecked Sendable {
  ...
  public var modifiedTimestamp: PbSystemDateTime {
    get {_storage._modifiedTimestamp ?? PbSystemDateTime()}
    set {_uniqueStorage()._modifiedTimestamp = newValue}
  }
  /// Returns true if `modifiedTimestamp` has been explicitly set.
  public var hasModifiedTimestamp: Bool {_storage._modifiedTimestamp != nil}
  /// Clears the value of `modifiedTimestamp`. Subsequent reads from it will return its default value.
  public mutating func clearModifiedTimestamp() {_uniqueStorage()._modifiedTimestamp = nil}
  ...
  public var hasMeanNightlyRecoveryRespirationInterval: Bool {_storage._meanNightlyRecoveryRespirationInterval != nil}
  /// Clears the value of `meanNightlyRecoveryRespirationInterval`. Subsequent reads from it will return its default value.
  public mutating func clearMeanNightlyRecoveryRespirationInterval() {_uniqueStorage()._meanNightlyRecoveryRespirationInterval = nil}

  /// The mean RRI from the baseline calculation. (ms)
  public var meanBaselineRri: Int32 {
    get {_storage._meanBaselineRri ?? 0}
    set {_uniqueStorage()._meanBaselineRri = newValue}
  }
  /// Returns true if `meanBaselineRri` has been explicitly set.
  public var hasMeanBaselineRri: Bool {_storage._meanBaselineRri != nil}
  /// Clears the value of `meanBaselineRri`. Subsequent reads from it will return its default value.
  public mutating func clearMeanBaselineRri() {_uniqueStorage()._meanBaselineRri = nil}

  /// The standard deviation of RRI from baseline calculation.
  public var sdBaselineRri: Int32 {
    get {_storage._sdBaselineRri ?? 0}
    set {_uniqueStorage()._sdBaselineRri = newValue}
  }
  /// Returns true if `sdBaselineRri` has been explicitly set.
  public var hasSdBaselineRri: Bool {_storage._sdBaselineRri != nil}
  /// Clears the value of `sdBaselineRri`. Subsequent reads from it will return its default value.
  public mutating func clearSdBaselineRri() {_uniqueStorage()._sdBaselineRri = nil}

  /// The mean RMSSD from the baseline calculation.
  public var meanBaselineRmssd: Int32 {
    get {_storage._meanBaselineRmssd ?? 0}
    set {_uniqueStorage()._meanBaselineRmssd = newValue}
  }
  /// Returns true if `meanBaselineRmssd` has been explicitly set.
  public var hasMeanBaselineRmssd: Bool {_storage._meanBaselineRmssd != nil}
  /// Clears the value of `meanBaselineRmssd`. Subsequent reads from it will return its default value.
  public mutating func clearMeanBaselineRmssd() {_uniqueStorage()._meanBaselineRmssd = nil}

  /// The standard deviation of RMSSD from baseline calculation.
  public var sdBaselineRmssd: Int32 {
    get {_storage._sdBaselineRmssd ?? 0}
    set {_uniqueStorage()._sdBaselineRmssd = newValue}
  }
  /// Returns true if `sdBaselineRmssd` has been explicitly set.
  public var hasSdBaselineRmssd: Bool {_storage._sdBaselineRmssd != nil}
  /// Clears the value of `sdBaselineRmssd`. Subsequent reads from it will return its default value.
  public mutating func clearSdBaselineRmssd() {_uniqueStorage()._sdBaselineRmssd = nil}

  /// mean Respiration Interval from the baseline calculation. (ms)
  public var meanBaselineRespirationInterval: Int32 {
    get {_storage._meanBaselineRespirationInterval ?? 0}
  ...
  public var hasMeanBaselineRespirationInterval: Bool {_storage._meanBaselineRespirationInterval != nil}
  /// Clears the value of `meanBaselineRespirationInterval`. Subsequent reads from it will return its default value.
  public mutating func clearMeanBaselineRespirationInterval() {_uniqueStorage()._meanBaselineRespirationInterval = nil}

  /// The standard deviation of Respiration Interval from baseline calculation.
  public var sdBaselineRespirationInterval: Int32 {
    get {_storage._sdBaselineRespirationInterval ?? 0}
  ...
  public var hasSdBaselineRespirationInterval: Bool {_storage._sdBaselineRespirationInterval != nil}
  /// Clears the value of `sdBaselineRespirationInterval`. Subsequent reads from it will return its default value.
  public mutating func clearSdBaselineRespirationInterval() {_uniqueStorage()._sdBaselineRespirationInterval = nil}

  /// Chosen sleep tip for the user.
  public var sleepTip: String {
    get {_storage._sleepTip ?? String()}
    set {_uniqueStorage()._sleepTip = newValue}
  }
  /// Returns true if `sleepTip` has been explicitly set.
  public var hasSleepTip: Bool {_storage._sleepTip != nil}
  /// Clears the value of `sleepTip`. Subsequent reads from it will return its default value.
  public mutating func clearSleepTip() {_uniqueStorage()._sleepTip = nil}

  /// Chosen vitality tip for the user.
  public var vitalityTip: String {
    get {_storage._vitalityTip ?? String()}
    set {_uniqueStorage()._vitalityTip = newValue}
  }
  /// Returns true if `vitalityTip` has been explicitly set.
  public var hasVitalityTip: Bool {_storage._vitalityTip != nil}
  /// Clears the value of `vitalityTip`. Subsequent reads from it will return its default value.
  public mutating func clearVitalityTip() {_uniqueStorage()._vitalityTip = nil}

  /// Chosen exercise tip for the user.
  public var exerciseTip: String {
    get {_storage._exerciseTip ?? String()}
    set {_uniqueStorage()._exerciseTip = newValue}
  }
  /// Returns true if `exerciseTip` has been explicitly set.
  public var hasExerciseTip: Bool {_storage._exerciseTip != nil}
  /// Clears the value of `exerciseTip`. Subsequent reads from it will return its default value.
  public mutating func clearExerciseTip() {_uniqueStorage()._exerciseTip = nil}
...
nonisolated extension Data_PbNightlyRecoveryStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbNightlyRecoveryStatus"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}created_timestamp\0\u{3}modified_timestamp\0\u{3}ans_status\0\u{3}recovery_indicator\0\u{3}recovery_indicator_sub_level\0\u{3}ans_rate\0\u{3}score_rate_OBSOLETE\0\u{3}mean_nightly_recovery_RRI\0\u{3}mean_nightly_recovery_RMSSD\0\u{3}mean_nightly_recovery_respiration_interval\0\u{3}mean_baseline_RRI\0\u{3}sd_baseline_RRI\0\u{3}mean_baseline_RMSSD\0\u{3}sd_baseline_RMSSD\0\u{3}mean_baseline_respiration_interval\0\u{3}sd_baseline_respiration_interval\0\u{3}sleep_tip\0\u{3}vitality_tip\0\u{3}exercise_tip\0\u{3}sleep_result_date\0")
  ...
  public static func ==(lhs: Data_PbNightlyRecoveryStatus, rhs: Data_PbNightlyRecoveryStatus) -> Bool {
