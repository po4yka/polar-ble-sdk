...
internal class PolarUserDeviceSettingsUtils {
    static func getUserDeviceSettings(client: BlePsFtpClient, deviceSettingsPath: String) async throws -> PolarUserDeviceSettings.PolarUserDeviceSettingsResult {
        ...
        let plannedOperation = PolarUserDeviceSettingsRuntimePlanner.operations(id: "get-user-device-settings", kind: "read", path: deviceSettingsPath)?.first
        ...
        PolarUserDeviceSettingsRuntimePlanner.plan(id: "get-user-device-settings", kind: "read", path: deviceSettingsPath)
