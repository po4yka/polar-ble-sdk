...
extension PolarBleApiImpl: PolarBleApi  {
    ...
    func getSplitOfflineRecord(_ identifier: String, entry: PolarOfflineRecordingEntry, secret: PolarRecordingSecret?) async throws -> PolarOfflineRecordingData {
        ...
        case let d as AccData: return .accOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime, settings: settings)
        case let d as GyrData: return .gyroOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime, settings: settings)
        case let d as MagData: return .magOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime, settings: settings)
        case let d as PpgData: return .ppgOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime, settings: settings)
        case let d as PpiData: return .ppiOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime)
        case let d as OfflineHrData: return .hrOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime)
        case let d as TemperatureData: return .temperatureOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime)
        case let d as SkinTemperatureData: return .skinTemperatureOfflineRecordingData(d.mapToPolarData(), startTime: offlineRecData.startTime)
        case let d as DerivedAccData: return processDerivedAccData(d, nil, offlineRecData)
