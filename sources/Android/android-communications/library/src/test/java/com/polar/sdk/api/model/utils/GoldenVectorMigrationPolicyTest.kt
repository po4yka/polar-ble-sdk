...
class GoldenVectorMigrationPolicyTest {
    ...
    private companion object {
        ...
        val PLATFORM_OWNED_COVERAGE_ROWS = mapOf(
            ...
            "GATT clients" to listOf("Partial", "platform-owned", "Keep transport clients platform-specific", "HTS temperature measurement byte codec, BAS battery status bitfield codec, and HR measurement byte codec are shared common-owned while notification lifecycle stays platform-owned"),
