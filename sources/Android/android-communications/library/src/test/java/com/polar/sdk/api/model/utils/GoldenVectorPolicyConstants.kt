...
internal val SOURCE_PROVENANCE_TERMS = listOf("characterization", "readiness", "planning", "backlog", "policy", "prototype", "Android", "iOS", "shared")
...
internal val TYPE_UTILS_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "typeUtilsReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val DEVICE_ID_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "deviceIdReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val ADVERTISEMENT_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "advertisementReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val PMD_SETTINGS_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "pmdSettingsReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val PMD_CONTROL_POINT_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "pmdControlPointReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val PMD_SECRET_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "pmdSecretReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val ECG_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "ecgReadinessManifestNamesEverySharedContractBehaviorFamily",
    ...
    "readSigned24",
    "malformedFrame",
    "PROTOCOL_ONLY_PLATFORM_OWNERSHIP"
)
internal val ACC_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "accReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val GYR_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "gyrReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val MAG_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "magReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val PPG_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "ppgFrameFamilySharedContractReadinessManifestNamesEverySharedContractParserPolicy",
    "protocol/sensors/ppg-frame-family-shared-contract-readiness.json",
...
internal val PPI_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "ppiReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val PRESSURE_TEMPERATURE_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "pressureTemperatureReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val OFFLINE_HR_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "offlineHrReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val OFFLINE_RECORDING_METADATA_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "offlineRecordingMetadataReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val TRAINING_SESSION_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "trainingSessionReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val SKIN_TEMPERATURE_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "skinTemperatureReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val SKIN_TEMPERATURE_DOMAIN_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "skinTemperatureDomainReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val DISK_SPACE_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "diskSpaceReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val SPO2_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "spo2ReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val WATCH_FACE_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "watchFaceReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val KVTX_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "kvtxReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val D2H_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "d2hNotificationMappingReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val D2H_STREAM_RUNTIME_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "d2hStreamRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val ACTIVITY_SUMMARY_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "activitySummaryReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val SLEEP_NIGHTLY_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "sleepNightlyReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val USER_DEVICE_SETTINGS_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "userDeviceSettingsModelReadinessManifestNamesEverySharedContractBehaviorFamily",
    "sdk/user-device-settings/settings-model-readiness.json",
    "user-device-settings-model-readiness",
    "compileVerifiedSharedContractCharacterization",
...
internal val SD_LOG_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "sdLogReadinessManifestNamesEverySharedContractBehaviorFamily",
    ...
    "compile-verification-gate",
    "SD-log shared ownership remains valid while this readiness manifest is executable from shared commonTest"
)
internal val EXERCISE_SESSION_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "exerciseSessionReadinessManifestNamesEverySharedContractBehaviorFamily",
    ...
    "compile-verification-gate",
    "Exercise-session shared ownership remains valid while this readiness manifest is executable from shared commonTest"
)
internal val AVAILABLE_DATA_TYPES_COMMON_POLICY_REQUIRED_TERMS = listOf(
    "availableDataTypesReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FIRST_TIME_USE_COMMON_POLICY_REQUIRED_TERMS = listOf(
    ...
    "firstTimeUseReadinessManifestNamesEverySharedContractBehaviorFamily",
    ...
    "compile-verification-gate",
    "First-time-use shared ownership remains valid while this readiness manifest is executable from shared commonTest"
)
...
internal val KMP_MODERN_STACK_AUDIT_REQUIRED_TERMS = listOf(
    ...
    "Android production consumes shared through `implementation(project(\":shared\"))`",
    "two-AAR compatibility model",
...
internal val PLATFORM_OWNED_COVERAGE_ROWS = mapOf(
    ...
    "Android Bluedroid host behavior" to listOf("Platform-specific", "Keep host-owned"),
    "iOS CoreBluetooth host behavior" to listOf("Platform-specific", "Keep host-owned")
)
...
internal val FEATURE_AVAILABILITY_TEST_REQUIRED_TERMS = listOf(
    ...
    "platform-client-readiness-boundary",
    "SDK feature availability shared ownership owns only deterministic service and capability preconditions"
)
internal val HARDWARE_SMOKE_VALIDATION_TERMS = listOf(
    ...
    "must not replace deterministic golden-vector tests, shared `commonTest` policy tests, Android facade characterization, or iOS XCTest characterization before shared ownership",
...
internal val REQUIRED_VALIDATION_SECTIONS = listOf("## Android", "## iOS", "## Shared Common")
internal val VALIDATION_NON_GRADLE_GATE_TERMS = listOf(
    ...
    ":repo-tools:validateGeneratedXcodeProject",
...
internal val IOS_XCTEST_EXECUTION_GATE_REQUIRED_TERMS = listOf(
    ...
    "Use XCTest failures from that command as shared ownership evidence",
    "fast",
    "full",
    "firmware",
    "PolarBleApiImplTests"
)
internal const val COVERAGE_REQUIRED_COLUMN = 4
internal val PARTIAL_SHARED_OWNERSHIP_GATE_TERMS = listOf("before", "keep ", "keep host-owned", "platform-specific", "common fake", "fake-transport", "implement", "add ")
internal val SHARED_OWNERSHIP_README_TERMS = listOf("common", "shared", "ownership")
...
internal val BYTE_LEVEL_COMMON_DEPENDENCY_DEFERRAL_TERMS = mapOf(
    ...
    "payload-parser-policy.json" to listOf(
        "Selected training payload protobuf field parsing now executes in shared",
...
internal val FAKE_TRANSPORT_COMMON_REST_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "restRequestTransportReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_REST_FACADE_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "restFacadeRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_REST_SERVICE_MAPPING_TEST_REQUIRED_TERMS = listOf(
    ...
    "restServiceListWrongTypeGoldenVectorPinsPlatformSplitForCommonDecoderOwnership",
    ...
    "restServiceMappingReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_REST_EVENT_COMPRESSION_TEST_REQUIRED_TERMS = listOf(
    ...
    "restEventCompressionReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_FILE_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "fileRuntimeErrorReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_FILE_FACADE_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "fileFacadeRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_BACKUP_UTILITY_TEST_REQUIRED_TERMS = listOf(
    ...
    "restorePayloads",
    "GET:/SYS/BACKUP.TXT",
    "restoreFailureGoldenVectorPinsPlatformSplitForCommonWorkflowOwnership",
    "backupWorkflowReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_OFFLINE_TRIGGER_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "offlineTriggerRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_FIRMWARE_UTILITY_TEST_REQUIRED_TERMS = listOf(
    ...
    "firmwareInvalidVersionGoldenVectorPinsTypedParseFailureForPublicWorkflowOwnership",
    "firmwareFileOrderingGoldenVectorDefinesExecutableCommonSystemUpdateLastPolicy",
    "firmwareUtilityReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_FIRMWARE_WORKFLOW_TEST_REQUIRED_TERMS = listOf(
    ...
    "firmwareWorkflowRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_PSFTP_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "writeAckCount",
    "psFtpRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_PSFTP_BYTE_CODEC_TEST_REQUIRED_TERMS = listOf(
    ...
    "psFtpByteCodecReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_STREAM_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "streamRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_COMMAND_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "resetSyncH10CommandReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_STORED_DATA_CLEANUP_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "cleanupWorkflowReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_DISK_TIME_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "diskTimeQueryReadinessManifestNamesEverySharedContractBehaviorFamily",
...
internal val FAKE_TRANSPORT_COMMON_USER_DEVICE_SETTINGS_RUNTIME_TEST_REQUIRED_TERMS = listOf(
    ...
    "userDeviceSettingsRuntimeReadinessManifestNamesEverySharedContractBehaviorFamily",
