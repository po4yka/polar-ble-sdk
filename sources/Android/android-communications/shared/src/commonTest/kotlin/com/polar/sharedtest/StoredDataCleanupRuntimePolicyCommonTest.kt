...
class StoredDataCleanupRuntimePolicyCommonTest {
    ...
    fun cleanupFilterHelpersExposeProductionSharedPolicy() {
        ...
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("ACT", "20260530/", cutoffFolder = "20260531"))
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("ACT", "20260531/", cutoffFolder = "20260531"))
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("ACT", "ACT/"))
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("ACT", "ACTIVITY.BPB"))
        assertEquals(false, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("ACT", "USERID.BPB"))
        assertEquals(false, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("ACT", "HIST.BPB"))
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("AUTOS", "20260530/"))
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("AUTOS", "AUTOS001.BPB"))
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("SDLOGS", "A.SLG"))
        assertEquals(true, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("SDLOGS", "B.TXT"))
        assertEquals(false, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("SDLOGS", "C.BPB"))
        assertEquals(false, PolarWorkflowRuntimePlanning.storedDataCleanupDirectoryEntryMatches("UNDEFINED", "20260530/"))
        ...
        assertEquals("/U/0", PolarWorkflowRuntimePlanning.storedDataCleanupRootPath("ACT", "/U/0"))
        assertEquals("/U/0/", PolarWorkflowRuntimePlanning.storedDataCleanupRootPath("SLEEP", "/U/0/"))
        assertEquals("/U/0/AUTOS", PolarWorkflowRuntimePlanning.storedDataCleanupRootPath("AUTOS", "/U/0"))
        assertEquals("/SDLOGS", PolarWorkflowRuntimePlanning.storedDataCleanupRootPath("SDLOGS", "/U/0"))
